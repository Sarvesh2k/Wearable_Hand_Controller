...
int main() {
  ...
  while (1) {
    if (new_key) {
      ...
      else if ( new_key == 0xB24D56A9 ) {         //Acc_left
        USARTWriteChar('2');
        USARTWriteChar('\n');
      }
      else if ( new_key == 0xB24D52AD ) {         //Acc_right
        USARTWriteChar('3');
        USARTWriteChar('\n');
      }
      else if ( new_key == 0xB24D6699 ) {         //Acceleration
        USARTWriteChar('4');
        USARTWriteChar('\n');
      }
      ...
      else if ( new_key == 0xB24DF0F0 ) {         //Brake
        USARTWriteChar('6');
        USARTWriteChar('\n');
      }
      else if ( new_key == 0xB24DA694  ) {        //Nitro
        USARTWriteChar('7');
        USARTWriteChar('\n');
      }
      new_key = 0;
